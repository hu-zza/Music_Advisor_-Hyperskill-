...
public abstract class Controller
{
    static void authorization()
    {
        ...
        System.out.println(codeForTokenRequest.isEmpty() ? "Code has not received." : "Code has received.");
    ...
    private static void fetchFromSpotify(String apiPath, String playlistId)
    {
        ...
        if (Model.containsPlaylist(playlistId)) return;
        ...
        do
        {
            ...
            if (LocalHttpClient.isErrorObject(responseJson)) return;
